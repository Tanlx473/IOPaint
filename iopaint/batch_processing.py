...
Utility functions for processing multiple images via the CLI.
"""
...
def glob_images(path: Path) -> Dict[str, Path]:
    """遍历路径，返回所有 PNG/JPG/JPEG 文件。

    Walk the path and return all PNG/JPG/JPEG files.
    """
...
def batch_inpaint(
    ...
    Run multiple inpainting tasks in batch mode.
    """
