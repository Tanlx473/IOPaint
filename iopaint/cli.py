...
本文件使用 ``typer`` 定义了 ``iopaint`` 命令，可启动 Web 服务器、下载模型
以及执行批量任务。


Command line interface implemented with ``typer``. It can start the
web server, download models and run batch jobs.
